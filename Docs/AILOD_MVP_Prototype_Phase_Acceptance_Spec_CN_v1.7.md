...
**版本：v1.7**<br>
**日期：2026-08-18**<br>
**状态：研究方向与 6G-B0 规则已由项目作者于 2026-08-18 确认；B0 随独立本地提交封板；B1 已获授权但尚未开始，B2—B5 尚未实现**<br>
**基准文档：`AILOD_MVP_Prototype_Implementation_Spec_CN.md` v1.1**<br>
**前序修订：v1.2、v1.3、v1.4、v1.5、v1.6**<br>
**工程证据：`AILOD_MVP_Phase6G_A_Checkpoint_CN.md`**<br>
...
- 明确旧规则覆盖、权威来源、精确/近似边界、Batch Claim、Capsule、Lift/Restrict、Schema/Digest 和逐步门；
