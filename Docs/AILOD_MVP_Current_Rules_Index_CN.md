...
当前位于 `phase-6g-b-cohort-batch`。Phase 6A—6F 已分别以本地提交 `71e3565`、`c0e84d2`、`eb44bf3`、`93282ed`、`6ee6873`、`c629bb6` 封板；6G-A、6G-B0、6G-B1、6G-B2A、6G-B2B、6G-B3、B4 和 B5A 已分别以本地提交 `41d3bae`、`8a1ac11`、`90020f2`、`af3b253`、`37120c4`、`0ed8c16`、`97e5843`、`8f7adbb` 封板。B5B 已把完整共享行为、地震、三种固定政策和 Schema 1.2 明细日志接入 v1.7，并完成固定 Seed、总人口 200 的四场景 Oracle 工程对照、离线指标重建、重放和 `35/35` 完整回归；复查还修正了分组标签与组内资源区间不一致的问题，四场景 2,503 条可行动群体记录错档为 0。当前等待项目作者确认，尚未提交。B5C—B5E 的 2k—100k 规模和 3 倍工程目标仍未完成；Phase 7 和 Phase 8 尚未开始。所有既有提交均未推送。
