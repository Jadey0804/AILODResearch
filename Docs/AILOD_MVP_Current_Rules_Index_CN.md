...
| Phase 6I-H6 Checkpoint | 每栋房紧凑状态、批量维修到具体房屋的对应、玩家靠近/离开时的住房连续性、住房承诺计时、5 Seed Pilot、20k 和 100k 复验 | H6 工程门已通过；剩余维修排期误差已量化，正式模型资格仍须作者明确接受后才能开放，40 Runs 仍不是正式统计 |
...
当前位于 `phase-6i-home-continuity`。B5E、H0、H1、H2、H3、H4、H5、H6-0 已分别以 `ef07f6c`、`669bea6`、`bd9079f`、`52795a0`、`ab59954`、`cecee95`、`4e11072`、`65ba234` 封板。项目作者已于 2026-08-21 采纳 v1.9 / H6 住房连续性定向修正；H6-A—H6-E 已完成实现和工程复验，H6-F 检查点已记录剩余误差，正式模型资格继续关闭并等待项目作者决定。所有提交均未推送。
